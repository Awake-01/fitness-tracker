...
const recommendedExercises = {
    ...
    chest: { name: '胸', exercises: ['平板杠铃卧推', '上斜杠铃卧推', '平板哑铃卧推', '上斜哑铃卧推', '平板哑铃飞鸟', '蝴蝶机夹胸', '绳索夹胸', '俯卧撑'] },
    ...
    core: { name: '核心', exercises: ['平板支撑', '侧平板支撑', '卷腹', '举腿', '悬垂举腿', '俄罗斯转体', '仰卧起坐', '跪姿绳索下压'] },
    glutes: { name: '臀', exercises: ['杠铃臀推', '髋外展机', '保加利亚单腿蹲', '深蹲', '弓步蹲'] },
    legs: { name: '腿', exercises: ['杠铃深蹲', '哑铃深蹲', '腿举机', '腿屈伸机', '腿弯举机', '深蹲', '弓步蹲'] },
